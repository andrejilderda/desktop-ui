const windowsTheme = {
  theme: {
    ...
    borderStyles: {
      default: '1px solid hsla(0, 0%, 0%, 0.02)',
      card_rest: '$default',
      card_pressed: '1px solid hsla(0, 0%, 0%, 0.1)',
      tooltip: '$default',
      flyout: '$default',
      dialog: '$default',
      inactive_windows: '$default',
    ...
    shadows: {
      ...
      card_rest: '0px 2px 4px 0px hsla(0, 0%, 0%, 0.13)',
      tooltip: '0px 4px 8px 0px hsla(0, 0%, 0%, 0.26)',
      flyout: '0px 8px 16px 0px hsla(0, 0%, 0%, 0.14)',
      dialog:
        '0px 2px 21px 0px hsla(0, 0%, 0%, 0.37), 0px 32px 64px 0px hsla(0, 0%, 0%, 0.37)',
      inactive_windows:
        '0px 2px 10.670000076293945px 0px hsla(0, 0%, 0%, 0.37), 0px 16px 32px 0px hsla(0, 0%, 0%, 0.37)',
      active_windows:
        '0px 2px 21px 0px hsla(0, 0%, 0%, 0.55), 0px 32px 64px 0px hsla(0, 0%, 0%, 0.56)',
    },
    zIndices: {},
    transitions: {},
  },
